test {
    ...
    _ = @import("emission/lowering/call_lowerer.test.zig");
    _ = @import("emission/lowering/member_access_lowerer.test.zig");
    _ = @import("emission/lowering/place_lowerer.test.zig");
    _ = @import("emission/lowering/binary_operation_lowerer.test.zig");
